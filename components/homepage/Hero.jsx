      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center ">
        ...
        >
          ...
          >
            ...
            providing advanced dental treatments, dental implants, oral surgery,
            and cosmetic smile solutions.
          </motion.p>
        ...
        <div className="w-full flex flex-col md:flex-row gap-4 lg:gap-6">
          ...
          <div className="flex-1 border-b md:border-b-0 md:border-r border-slate-100 pb-4 md:pb-0 md:pr-4 group">
            ...
            <div className="flex items-center gap-3 text-slate-700">
              ...
              <input
                ...
                className="w-full outline-none text-sm font-medium focus:ring-2 focus:ring-blue-100 rounded-md py-1 px-2 transition-all bg-transparent"
              />
            </div>
          </div>
          ...
          <div className="flex-1 border-b md:border-b-0 md:border-r border-slate-100 pb-4 md:pb-0 md:pr-4 group">
            ...
            <div className="flex items-center gap-3 text-slate-700">
              ...
              <input
                type="date"
                className="w-full outline-none text-sm font-medium focus:ring-2 focus:ring-blue-100 rounded-md py-1 px-2 transition-all bg-transparent text-slate-700 cursor-pointer"
              />
            </div>
          </div>
