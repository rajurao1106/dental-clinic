    ...
    <section className="bg-[#0b1a33] py-24 px-8 flex flex-col items-center overflow-hidden">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
          <span className="text-blue-500">Dental Care FAQ:</span> Your <br className="hidden md:block" />
          Questions Answered
        </h2>
      </motion.div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
            ...
            return (
              ...
              >
                ...
                <div className="px-6 py-5 flex items-center justify-between">
                  <h4 className={`font-bold text-sm md:text-base transition-colors duration-300 ${isOpen ? 'text-white' : 'text-gray-900'}`}>
                    {faq.question}
                  </h4>
                  <motion.button 
                    initial={false}
        ...
        >
          {/* Support CTA Card */}
          <motion.div variants={slideInRight} className="bg-blue-600 rounded-3xl p-10 flex flex-col items-center text-center shadow-lg">
            <motion.div 
              animate={{ y: [0, -8, 0] }}
          ...
          >
            <div className="w-14 h-14 bg-blue-50 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-blue-600 transition-colors duration-300">
              <PhoneCall size={24} className="text-blue-600 group-hover:text-white transition-colors duration-300" />
            </div>
            <div>
              <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">
                Your Smile, Our Priority
              </p>
              <h4 className="text-lg font-bold text-gray-900 mb-1">24/7 Emergency</h4>
