...
import { ArrowRight, Sparkles, ShieldPlus, Clock, Activity, Smile, Stethoscope } from 'lucide-react';
...
const Services = () => {
  ...
  const services = [
    {
      ...
      description: 'Permanent replacement for missing teeth with advanced implant systems including conventional and basal implants.',
    ...
    },
    {
      ...
      description: 'Get fixed teeth in just 72 hours using modern implant-supported rehabilitation and advanced protocols.',
      image: '/service-72hours.jpg',
      icon: Clock,
      isActive: false,
    },
    {
      title: 'Root Canal Treatment',
      description: 'Save infected teeth with painless root canal procedures using advanced endodontic technology.',
      image: '/service-root-canal.jpg',
      icon: Activity,
      isActive: false,
    },
    {
      title: 'Braces & Clear Aligners',
      description: 'Straighten teeth and correct your bite with modern, invisible orthodontic solutions.',
    ...
    },
    {
      ...
      description: 'Safe and comfortable surgical extraction of impacted wisdom teeth by our expert oral surgeon.',
    ...
    },
    {
      ...
      description: 'Improve aesthetics with custom veneers, whitening, and comprehensive cosmetic procedures.',
  ...
  return (
    <section className="bg-slate-50 flex flex-col relative">
        ...
        >
          {services.map((service, idx) => (
            <motion.div 
              ...
              variants={fadeUp}
              whileHover={{ y: -8 }}
              className={`group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 transition-shadow duration-500 flex flex-col cursor-pointer ${
                service.isActive ? 'border-2 border-blue-600 ring-4 ring-blue-50' : 'border border-slate-100'
              }`}
            >
              ...
              <div className="pt-14 pb-8 px-8 flex-1 flex flex-col">
                ...
                <div 
                  className={`inline-flex items-center gap-2 text-sm font-bold transition-all duration-300 w-fit ${
                    service.isActive ? 'text-blue-600' : 'text-slate-700 group-hover:text-blue-600'
                  }`}
                >
                  Learn more 
